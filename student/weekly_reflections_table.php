        ...
        <div class="px-6 py-5 hover:bg-slate-50/50 transition-colors duration-150">
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-emerald-500 text-white flex items-center justify-center text-sm font-bold">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                ...
                <div class="bg-slate-50 border border-slate-100 rounded-xl p-4">
                    <span class="text-sm font-bold text-slate-400 uppercase tracking-wider block mb-2">How was it done?</span>
