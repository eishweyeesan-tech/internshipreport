                ...
                <div class="px-5 py-4 hover:bg-slate-50/50 transition-colors duration-150">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div class="bg-slate-50 rounded-xl p-3.5">
                            <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider block mb-1">ဘာလုပ်သလဲ</span>
                            <p class="text-sm text-gray-700 leading-normal"><?= nl2br(htmlspecialchars($ref['what_done'] ?? '')) ?></p>
                        </div>
                        <div class="bg-slate-50 rounded-xl p-3.5">
                            <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider block mb-1">ဘယ်လိုလုပ်ပါသလဲ</span>
                            <p class="text-sm text-gray-700 leading-normal"><?= nl2br(htmlspecialchars($ref['how_done'] ?? '')) ?></p>
                        </div>
                        <div class="bg-slate-50 rounded-xl p-3.5">
                            <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider block mb-1">ဘာကြောင့်လုပ်ပါသလဲ</span>
