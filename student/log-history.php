                                                ...
                                                <div class="rounded-xl border border-slate-200 bg-gradient-to-b from-slate-50/70 to-white p-3.5 flex flex-col">
                                                    <div class="flex items-center gap-2.5 mb-2">
                                                        ...
                                                        <?php if (!empty($week_sup_eval['weekly_grade'])): ?>
                                                            ...
                                                            $sgd = ['A' => ['Grade: A', 'text-emerald-600 bg-emerald-50'], 'B' => ['Grade: B', 'text-blue-600 bg-blue-50'], 'C' => ['Grade: C', 'text-amber-600 bg-amber-50'], 'D' => ['Grade: D', 'text-orange-600 bg-orange-50'], 'F' => ['Grade: F', 'text-red-600 bg-red-50']];
                                                            $sgdi = $sgd[$sg] ?? [$sg, 'text-slate-100 bg-slate-50']; ?>
                                                        ...
                                                        <div class="rounded-xl border border-slate-200 bg-gradient-to-b from-slate-50/70 to-white p-3.5 flex flex-col">
                                                            <div class="flex items-center gap-2.5 mb-2">
                                                                ...
                                                                <?php if ($week_eval_m && $week_eval_m['report_status'] !== 'pending'): ?>
                                                                    ...
                                                                    $igd_m = $gmap_m[$ig_m] ?? ['—', 'text-slate-400', 'bg-slate-50']; ?>
                                                        ...
                                                        <div class="rounded-xl border border-slate-200 bg-gradient-to-b from-slate-50/70 to-white p-3.5 flex flex-col">
                                                            <div class="flex items-center gap-2.5 mb-2">
                                                                ...
                                                                <?php if (!empty($week_sup_eval_m['weekly_grade'])): ?>
                                                                    ...
                                                                    $sgd_m = ['A' => ['Grade: A', 'text-emerald-600 bg-emerald-50'], 'B' => ['Grade: B', 'text-blue-600 bg-blue-50'], 'C' => ['Grade: C', 'text-amber-600 bg-amber-50'], 'D' => ['Grade: D', 'text-orange-600 bg-orange-50'], 'F' => ['Grade: F', 'text-red-600 bg-red-50']];
                                                                    $sgdi_m = $sgd_m[$sg_m] ?? [$sg_m, 'text-slate-100 bg-slate-50']; ?>
