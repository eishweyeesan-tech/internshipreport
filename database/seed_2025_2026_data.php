<?php
/**
 * Database Seeder for Academic Year 2025-2026 (Myanmar Language Edition)
 * InternReport Management System
 * 
 * Period: May 5, 2026 to July 31, 2026 (13 Weeks / 64 Weekdays)
 * Students: 12 Students (5CS-1 to 5CS-12) with Complete Realistic Data in Myanmar Language (မြန်မာဘာသာ)
 * - Daily Logs (Tasks, Tools, Skills, Start/End times, Duration, Absences in Myanmar)
 * - Weekly Reflections (What, How, Why in Myanmar)
 * - Instructor Evaluations (Grades, Signatures, Comments in Myanmar)
 * - Supervisor Weekly Evaluations (A/B Grades, Comments in Myanmar)
 * - Notifications (Approval and evaluation alerts in Myanmar)
 */
...
echo "====================================================\n";
echo "Starting 2025-2026 Mock Data Seeder (12 Students, 13 Weeks)...\n";
echo "====================================================\n";

// 1. Get or verify Academic Year 2025-2026
$ay_label = '2025-2026';
...
if ($row = $res->fetch_assoc()) {
    ...
    $conn->query("INSERT INTO academic_years (year_label, start_date, end_date, is_current, status) VALUES ('2025-2026', '2025-09-01', '2026-08-31', 1, 'Active')");
    $academic_year_id = $conn->insert_id;
}

// Ensure academic_years 2025-2026 is active & current
$conn->query("UPDATE academic_years SET is_current = 0 WHERE id != $academic_year_id");
$conn->query("UPDATE academic_years SET is_current = 1, status = 'Active' WHERE id = $academic_year_id");
...
// Clean previous 2025-2026 students and related records cleanly
$prev_user_ids = [];
$res = $conn->query("SELECT id FROM users WHERE academic_year = '2025-2026' AND role = 'student'");
while ($r = $res->fetch_assoc()) {
    $prev_user_ids[] = (int)$r['id'];
}

if (!empty($prev_user_ids)) {
    $id_list = implode(',', $prev_user_ids);
    $conn->query("DELETE FROM daily_logs WHERE internship_id IN ($id_list)");
    $conn->query("DELETE FROM weekly_reflections WHERE internship_id IN ($id_list)");
    $conn->query("DELETE FROM report_evaluations WHERE student_id IN ($id_list)");
    $conn->query("DELETE FROM supervisor_weekly_evaluations WHERE student_id IN ($id_list)");
    $conn->query("DELETE FROM magic_links WHERE internship_id IN ($id_list)");
    $conn->query("DELETE FROM notifications WHERE user_id IN ($id_list)");
    $conn->query("DELETE FROM student_profiles WHERE user_id IN ($id_list)");
    $conn->query("DELETE FROM users WHERE id IN ($id_list)");
    echo "Cleaned " . count($prev_user_ids) . " existing 2025-2026 student records.\n";
}

// 3. Define 12 Students for 2025-2026 (5CS-1 to 5CS-12)
$students_data = [
    [
        'username'        => '5CS-1',
        'email'           => 'nangeikhaing@gmail.com',
        'full_name'       => 'Nang Ei Khaing',
        'student_roll'    => '5CS-1',
        ...
        'instructor_name' => 'U Zaw Lwin (Senior Architect)',
        'instructor_email'=> 'eishweyeesan@gmail.com',
        'instructor_phone'=> '09-798112244',
        'tech_stack'      => 'PHP 8.2, JavaScript ES6, MySQL, REST API, Tailwind CSS, Git',
    ],
    [
        'username'        => '5CS-2',
        'email'           => 'thinzar.2025@gmail.com',
        'full_name'       => 'Thinzar Aung',
        'student_roll'    => '5CS-2',
        'major'           => 'Computer Science',
        'phone'           => '09-781902341',
    ...
    [
        'username'        => '5CS-3',
        'email'           => 'kyawzin.2025@gmail.com',
        'full_name'       => 'Kyaw Zin Thant',
        'student_roll'    => '5CS-3',
        'major'           => 'Computer Science',
        'phone'           => '09-250192843',
    ...
    [
        'username'        => '5CS-4',
        'email'           => 'maymyatnoe.2025@gmail.com',
        'full_name'       => 'May Myat Noe',
        'student_roll'    => '5CS-4',
        'major'           => 'Computer Science',
        'phone'           => '09-965419208',
    ...
    [
        'username'        => '5CS-5',
        'email'           => 'heinhtet.2025@gmail.com',
        'full_name'       => 'Hein Htet Aung',
        'student_roll'    => '5CS-5',
    ...
    [
        'username'        => '5CS-6',
        'email'           => 'hsumyat.2025@gmail.com',
        'full_name'       => 'Hsu Myat Thu',
        'student_roll'    => '5CS-6',
        'major'           => 'Computer Science',
        'phone'           => '09-420019554',
    ...
    [
        'username'        => '5CS-7',
        'email'           => 'kaungkhant.2025@gmail.com',
        'full_name'       => 'Kaung Khant Kyaw',
        'student_roll'    => '5CS-7',
        'major'           => 'Computer Science',
        'phone'           => '09-254499876',
    ...
    [
        'username'        => '5CS-8',
        'email'           => 'yoonnadi.2025@gmail.com',
        'full_name'       => 'Yoon Nadi Oo',
        'student_roll'    => '5CS-8',
        'major'           => 'Computer Technology',
        'phone'           => '09-790182765',
    ...
    [
        'username'        => '5CS-9',
        'email'           => 'aungphone.2025@gmail.com',
        'full_name'       => 'Aung Phone Myint',
        'student_roll'    => '5CS-9',
        'major'           => 'Computer Technology',
        'phone'           => '09-459981890',
    ...
    [
        'username'        => '5CS-10',
        'email'           => 'sumyatnoe.2025@gmail.com',
    ...
    [
        'username'        => '5CS-11',
        'email'           => 'minkhant.2025@gmail.com',
        'full_name'       => 'Min Khant Thu',
        'student_roll'    => '5CS-11',
        'major'           => 'Computer Science',
        'phone'           => '09-450998877',
        'job_role'        => 'Backend PHP/Laravel Developer',
    ...
    [
        'username'        => '5CS-12',
        'email'           => 'thethtar.2025@gmail.com',
        'full_name'       => 'Thet Htar San',
        'student_roll'    => '5CS-12',
        'major'           => 'Computer Science',
        'phone'           => '09-781001122',
        'job_role'        => 'Frontend React Developer',
...
// 13 Weeks definitions (May 5, 2026 to July 31, 2026)
$weeks_schedule = [
    1  => ['start' => '2026-05-05', 'end' => '2026-05-08'],
    2  => ['start' => '2026-05-11', 'end' => '2026-05-15'],
    3  => ['start' => '2026-05-18', 'end' => '2026-05-22'],
    4  => ['start' => '2026-05-25', 'end' => '2026-05-29'],
    5  => ['start' => '2026-06-01', 'end' => '2026-06-05'],
    6  => ['start' => '2026-06-08', 'end' => '2026-06-12'],
    7  => ['start' => '2026-06-15', 'end' => '2026-06-19'],
    8  => ['start' => '2026-06-22', 'end' => '2026-06-26'],
    9  => ['start' => '2026-06-29', 'end' => '2026-07-03'],
    10 => ['start' => '2026-07-06', 'end' => '2026-07-10'],
    11 => ['start' => '2026-07-13', 'end' => '2026-07-17'],
    12 => ['start' => '2026-07-20', 'end' => '2026-07-24'],
    13 => ['start' => '2026-07-27', 'end' => '2026-07-31'],
];
...
$weekly_curriculum_mm = [
    ...
    'Full-Stack Web Developer' => [
        1  => [
            'ခေါင်းစဉ်' => 'Full-Stack Architecture & Environment Setup',
            'လုပ်ဆောင်ချက်' => 'Node.js, Express, PHP/Laravel, PostgreSQL/MySQL နှင့် Git workflow များကို ကုမ္ပဏီစံနှုန်းနှင့်အညီ setup ပြုလုပ်ခြင်း။',
            'ကျွမ်းကျင်မှု' => 'Full-stack tooling, Git collaboration, Docker containerization, REST architecture.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'ပရောဂျက်အတွက် လိုအပ်သော Development Tools များနှင့် Backend/Frontend Project Structure များကို အောင်မြင်စွာ ပြင်ဆင်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Senior Developer များ၏ လမ်းညွှန်မှုဖြင့် Code Standard များနှင့် Git flow ကို စနစ်တကျ လေ့ကျင့်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'အဖွဲ့လိုက် တည်ငြိမ်ချောမွေ့စွာ Project စတင်နိုင်စေရန် ဖြစ်ပါသည်။'
        ],
        2  => [
            'ခေါင်းစဉ်' => 'Database Modeling & API Contracts Design',
            'လုပ်ဆောင်ချက်' => 'စနစ်အတွက် လိုအပ်သော Relational Database ERD ရေးဆွဲခြင်း၊ API Contracts (JSON Schema) များ သတ်မှတ်ခြင်း။',
            'ကျွမ်းကျင်မှု' => 'ER diagramming, JSON schema specification, relational normalization.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'Database Tables များနှင့် Backend-Frontend ဆက်သွယ်မည့် API Payload စံနှုန်းများကို ရေးဆွဲခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'PostgreSQL/MySQL ပေါ်တွင် Schema Migrations များ ရေးသားပြီး Swagger UI ဖြင့် Docs ပြုစုခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'Backend နှင့် Frontend ချိတ်ဆက်ရာတွင် အချက်အလက် ကွဲလွဲမှု မရှိစေရန် ဖြစ်ပါသည်။'
        ],
        3  => [
            'ခေါင်းစဉ်' => 'RESTful API Services Development & Authentication',
            'လုပ်ဆောင်ချက်' => 'JWT Token Auth, User Profile Management API များနှင့် Secure Endpoints များ ရေးသားခြင်း။',
            'ကျွမ်းကျင်မှု' => 'REST API development, JWT security, password hashing, unit testing.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'လုံခြုံစိတ်ချရသော RESTful API endpoints များကို ရေးသားပြီး Postman ဖြင့် အောင်မြင်စွာ စမ်းသပ်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'MVC architecture ကို အခြေခံ၍ Clean Controller-Service-Repository pattern ဖြင့် ရေးသားခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'System Client များ အားလုံးအတွက် လုံခြုံသော ဒေတာစီးဆင်းမှု ရရှိစေရန် ဖြစ်ပါသည်။'
        ],
        4  => [
            'ခေါင်းစဉ်' => 'Frontend Views Integration & Dynamic Data Binding',
            'လုပ်ဆောင်ချက်' => 'API မှ Data များကို Frontend Table, Cards, Charts များတွင် Dynamic Render ပြုလုပ်ပေးခြင်း။',
            'ကျွမ်းကျင်မှု' => 'AJAX/Fetch API, JSON parsing, DOM manipulation, state management.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'Backend API ဒေတာများကို Frontend UI မျက်နှာပြင်များနှင့် အောင်မြင်စွာ ပေါင်းစပ်ချိတ်ဆက်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Asynchronous JavaScript (async/await) ဖြင့် Backend Call များကို စနစ်တကျ ကိုင်တွယ်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'အသုံးပြုသူများအတွက် လျင်မြန်သော Single Page အတွေ့အကြုံ ရရှိစေရန် ဖြစ်ပါသည်။'
        ],
        5  => [
            'ခေါင်းစဉ်' => 'Form Validation & Real-time Client-Side Checking',
            'လုပ်ဆောင်ချက်' => 'Client-side နှင့် Server-side နှစ်ဖက်စလုံးတွင် Data Validation စည်းမျဉ်းများ ထည့်သွင်းခြင်း။',
            'ကျွမ်းကျင်မှု' => 'Regex validation, error boundary handling, user experience refinement.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'မှားယွင်းသော ဒေတာများ မဝင်ရောက်နိုင်စေရန် နှစ်ထပ်ကွမ်း Form Validation စနစ်ကို ထည့်သွင်းခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'HTML5 Form API နှင့် Backend Validator Rules များကို စနစ်တကျ ပေါင်းစပ်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'Database အချက်အလက် ခိုင်မာသန့်ရှင်းမှု ရှိစေရန် ဖြစ်ပါသည်။'
        ],
        6  => [
            'ခေါင်းစဉ်' => 'File Upload, Compression & Storage Management',
            'လုပ်ဆောင်ချက်' => 'ကျောင်းသား အစီရင်ခံစာ ပူးတွဲဖိုင်များနှင့် Profile ပုံများကို လုံခြုံစွာ သိမ်းဆည်းနိုင်သော Storage Service ရေးသားခြင်း။',
            'ကျွမ်းကျင်မှု' => 'MIME validation, secure file naming, image thumbnail generation.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'Multi-file Upload နှင့် Image Compression လုပ်ဆောင်ချက်များကို ရေးသားပြီးမြောက်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'File Size & Type စစ်ဆေးမှုများကို Server Middleware ဖြင့် တင်းကျပ်စွာ စစ်ဆေးခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'Server Disk အလေအလွင့် နည်းပါးစေရန်နှင့် လုံခြုံရေး အားကောင်းစေရန် ဖြစ်ပါသည်။'
        ],
        7  => [
            'ခေါင်းစဉ်' => 'Email Notifications & Scheduled Reminders',
            'လုပ်ဆောင်ချက်' => 'အပတ်စဉ် Report တင်ရန် ကျန်ရှိသူများထံ အလိုအလျောက် သတိပေး Email ပေးပို့သော Cron Job Helper ရေးသားခြင်း။',
            'ကျွမ်းကျင်မှု' => 'PHPMailer, SMTP integration, background task scheduling.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'ကျောင်းသားနှင့် ဆရာများအကြား အလိုအလျောက် အသိပေးစာ ပေးပို့နိုင်သည့် Mail Service ကို ထည့်သွင်းခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'SMTP Queue Handler ဖြင့် အီးမေးလ် ပေးပို့မှု လုပ်ငန်းစဉ်ကို ရေးဆွဲခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'လုပ်ငန်းစဉ် တိုးတက်မှုကို အချိန်မီ သိရှိနိုင်စေရန် ဖြစ်ပါသည်။'
        ],
        8  => [
            'ခေါင်းစဉ်' => 'Database Query Optimization & Caching Strategies',
            'လုပ်ဆောင်ချက်' => 'ရှာဖွေမှု အမြန်နှုန်း မြှင့်တင်ရန် Database Composite Indexing ပြုလုပ်ခြင်းနှင့် In-memory Cache သုံးခြင်း။',
            'ကျွမ်းကျင်မှု' => 'SQL indexing, query execution plan analysis, in-memory caching.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'Query Response Speed ကို ၅၀% ကျော် မြန်ဆန်လာအောင် Database Tuning ပြုလုပ်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Slow Query Logs များကို စစ်ဆေး၍ လိုအပ်သော Index များ ဖြည့်စွက်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'စနစ်အသုံးပြုသူ များပြားလာချိန်တွင် ဝန်မပိစေရန် ဖြစ်ပါသည်။'
        ],
        9  => [
            'ခေါင်းစဉ်' => 'Unit Testing & End-to-End Functional Verification',
            'လုပ်ဆောင်ချက်' => 'ရေးသားထားသော လုပ်ဆောင်ချက်များ အားလုံးကို Test Suites များဖြင့် အလိုအလျောက် စစ်ဆေးခြင်း။',
            'ကျွမ်းကျင်မှု' => 'Automated testing, regression checking, test assertion patterns.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'Core Module များအတွက် Feature Test Cases များကို ရေးသား စစ်ဆေးခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Test Runner ဖြင့် Automated Regression Checks များကို Run ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'Code ပြင်ဆင်သည့်အခါ Error မဖြစ်ပေါ်စေရန် ဖြစ်ပါသည်။'
        ],
        10 => [
            'ခေါင်းစဉ်' => 'Security Hardening, CSRF/XSS Protection & RBAC',
            'လုပ်ဆောင်ချက်' => 'စနစ်အတွင်း XSS, CSRF, SQL Injection ကာကွယ်ရေးနှင့် Role-based Access Control စနစ် ချိန်ညှိခြင်း။',
            'ကျွမ်းကျင်မှု' => 'Web security audit, OWASP top 10 prevention, RBAC authorization.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'လုံခြုံရေး အားနည်းချက်များကို စစ်ဆေးကာ RBAC Role-based Permissions များကို တင်းကျပ်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Security Headers နှင့် Token validation များကို Middleware အဆင့်တွင် ထည့်သွင်းခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'ဒေတာ လုံခြုံစိတ်ချရမှု အဆင့်အတန်း မြင့်မားစေရန် ဖြစ်ပါသည်။'
        ],
        11 => [
            'ခေါင်းစဉ်' => 'Export & Reporting Engine (PDF/Excel Generation)',
            'လုပ်ဆောင်ချက်' => 'ကျောင်းသားများ၏ ၁၂ ပတ်စာ အစီရင်ခံစာများကို PDF/Excel format ဖြင့် ထုတ်ယူနိုင်သည့် Engine ရေးသားခြင်း။',
            'ကျွမ်းကျင်မှု' => 'PDF rendering, Excel spreadsheet export, layout formatting.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'တက္ကသိုလ်တင်ပြရန် တရားဝင် အစီရင်ခံစာ စာရွက်စာတမ်း ထုတ်ယူသည့် စနစ်ကို တည်ဆောက်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Print-friendly CSS နှင့် PDF library များကို အသုံးပြု၍ ရေးဆွဲခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'စာရွက်စာတမ်း အထောက်အထားများ အဆင်ပြေစွာ ပရင့်ထုတ်နိုင်ရန် ဖြစ်ပါသည်။'
        ],
        12 => [
            'ခေါင်းစဉ်' => 'Cloud Deployment, SSL Setup & CI/CD Pipeline',
            'လုပ်ဆောင်ချက်' => 'Staging Server ပေါ်သို့ Deploy လုပ်ခြင်း၊ Domain SSL Certificate တပ်ဆင်ခြင်းနှင့် GitHub Actions CI/CD စမ်းသပ်ခြင်း။',
            'ကျွမ်းကျင်မှု' => 'Server configuration, SSL setup, GitHub Actions CI/CD, deployment.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => 'စနစ်ကို Live Server ပေါ်တွင် အောင်မြင်စွာ တပ်ဆင်စမ်းသပ်နိုင်ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'CI/CD pipeline ဖြင့် Auto-deployment script များကို စမ်းသပ် run ခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'အသုံးပြုသူများ တိုက်ရိုက် သုံးစွဲနိုင်သော အခြေအနေသို့ ရောက်ရှိစေရန် ဖြစ်ပါသည်။'
        ],
        13 => [
            'ခေါင်းစဉ်' => 'Final Project Review, Technical Handover & Showcase',
            'လုပ်ဆောင်ချက်' => 'ပရောဂျက်တစ်ခုလုံး၏ Documentation ပြုစုခြင်း၊ Code handover ပြုလုပ်ခြင်းနှင့် Live Demonstration ပြသခြင်း။',
            'ကျွမ်းကျင်မှု' => 'Project documentation, team presentation, project handover.',
            'အပတ်စဉ်သုံးသပ်ချက်_what' => '၁၃ ပတ်စာ သင်ယူလေ့လာမှု ရလဒ်များနှင့် Full-Stack System ကို အောင်မြင်စွာ တင်ပြခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_how' => 'Live Demo နှင့် Slide Presentation ဖြင့် Team Lead ထံသို့ အောင်မြင်စွာ လွှဲပြောင်းခဲ့ပါသည်။',
            'အပတ်စဉ်သုံးသပ်ချက်_why' => 'Internship သင်ယူမှု ရည်မှန်းချက်များ ပြည့်စုံစွာ ပြီးမြောက်ကြောင်း သက်သေပြနိုင်ခဲ့သောကြောင့် ဖြစ်ပါသည်။'
        ],
    ],
];

// Fallback Myanmar curriculum
$default_curriculum_mm = $weekly_curriculum_mm['Full-Stack Web Developer'];

// Specific revision requested weeks (in Myanmar Language) - keep it clean with occasional revision
$revision_rules_mm = [
    2 => [
        4 => "Laravel Sanctum Token သက်တမ်းကုန်ဆုံးချိန် ကိုင်တွယ်ပုံနှင့် Frontend Axios interceptor ဖြင့် ချိတ်ဆက်ထားသည့် အဆင့်များကို အသေးစိတ် ထပ်မံဖြည့်စွက်ရေးသားပြီး ပြန်လည်တင်ပြပေးပါရန်။",
    ],
    5 => [
...
// Realistic Leave reasons in Myanmar Language for 2026
$absence_rules_mm = [
    0 => [
        '2026-05-20' => ['status' => 'leave', 'reason' => 'ရာသီတုပ်ကွေးဖျားနာမှုကြောင့် ဆေးခွင့်တင်ပြခြင်း (ဆရာဝန်ထောက်ခံစာ ပူးတွဲတင်ပြပြီး)'],
    ],
    1 => [
        '2026-06-10' => ['status' => 'leave', 'reason' => 'တက္ကသိုလ် ပညာရေးဆိုင်ရာ ဆွေးနွေးပွဲနှင့် နှီးနှောဖလှယ်ပွဲ တက်ရောက်ရန် ခွင့်တိုင်ကြားခြင်း'],
    ],
    2 => [
        '2026-07-01' => ['status' => 'leave', 'reason' => 'မိသားစု အရေးပေါ်ကိစ္စကြောင့် ခွင့်တိုင်ကြားခြင်း (ကုမ္ပဏီမန်နေဂျာထံ ကြိုတင်ခွင့်ပြုချက်ရယူပြီး)'],
    ],
    3 => [
        '2026-05-27' => ['status' => 'leave', 'reason' => 'မိသားစုကိစ္စဖြင့် အရေးပေါ်ခွင့်ယူခြင်း (တာဝန်ခံထံ ကြိုတင်အကြောင်းကြားပြီး)'],
    ],
    4 => [
        '2026-06-17' => ['status' => 'leave', 'reason' => 'ဖျားနာမှုကြောင့် ဆေးခွင့်တင်ပြခြင်း (ဆေးလက်မှတ် ပူးတွဲတင်ပြပြီး)'],
    ],
    5 => [
        '2026-07-15' => ['status' => 'leave', 'reason' => 'တက္ကသိုလ် စာမေးပွဲနှင့် ပညာရေးစာရွက်စာတမ်း တင်ပြရန် ခွင့်ရယူခြင်း'],
    ],
    6 => [
        '2026-06-03' => ['status' => 'leave', 'reason' => 'တက္ကသိုလ် သုတေသနပရောဂျက် ဆွေးနွေးတိုင်ပင်ရန် တရားဝင် ခွင့်တိုင်ကြားခြင်း'],
    ],
    7 => [
        '2026-05-13' => ['status' => 'leave', 'reason' => 'ကျန်းမာရေး စစ်ဆေးမှုပြုလုပ်ရန် ဆေးရုံ/ဆေးခန်း ပြသခွင့် တင်ပြခြင်း'],
    ],
    8 => [
        '2026-07-08' => ['status' => 'leave', 'reason' => 'အစာအဆိပ်သင့် ဖျားနာမှုကြောင့် ဆေးခွင့်တင်ပြခြင်း'],
    ],
    9 => [
        '2026-06-24' => ['status' => 'leave', 'reason' => 'တက္ကသိုလ် အလုပ်အကိုင်ပြပွဲ (Career Fair) နှင့် ဆွေးနွေးပွဲ တက်ရောက်ရန် ခွင့်ရယူခြင်း'],
    ],
    10 => [
        '2026-05-22' => ['status' => 'leave', 'reason' => 'ရာသီဥတု ဖျားနာမှုကြောင့် ဆေးခွင့်ရယူခြင်း'],
    ],
    11 => [
        '2026-07-17' => ['status' => 'leave', 'reason' => 'တက္ကသိုလ် စာရွက်စာတမ်း အတည်ပြုချက် ရယူရန် ခွင့်တိုင်ကြားခြင်း'],
    ],
];
...
echo "\n====================================================\n";
echo "SUCCESS! 12 Students generated for 2025-2026 with full Myanmar content!\n";
echo "====================================================\n";
